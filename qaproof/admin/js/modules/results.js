...
(function () {
  ...
  function renderResponsiveResults(data) {
    ...
    if (hasScreenshots) {
      ...
      var vw = data.viewportWidths || {};
      var defaultVw = { desktop: 1440, tablet: 768, tablet_landscape: 1024, mobile: 375, mobile_landscape: 812 };
      var wpx = function(d) { var w = vw[d] || defaultVw[d]; return w ? '<span class="qaproof-vp-px">' + w + 'px</span>' : ''; };
      html += '          <button type="button" class="qaproof-device-tab active" data-device="desktop">Desktop' + wpx('desktop') + '</button>';
      html += '          <button type="button" class="qaproof-device-tab" data-device="tablet">Tablet' + wpx('tablet') + '</button>';
      html += '          <button type="button" class="qaproof-device-tab" data-device="tablet_landscape">Tablet <span class="dashicons dashicons-image-rotate" style="font-size:14px;width:14px;height:14px;vertical-align:middle;margin-left:2px;"></span>' + wpx('tablet_landscape') + '</button>';
      html += '          <button type="button" class="qaproof-device-tab" data-device="mobile">Mobile' + wpx('mobile') + '</button>';
      html += '          <button type="button" class="qaproof-device-tab" data-device="mobile_landscape">Mobile <span class="dashicons dashicons-image-rotate" style="font-size:14px;width:14px;height:14px;vertical-align:middle;margin-left:2px;"></span>' + wpx('mobile_landscape') + '</button>';
      html += '        </div>';
      html += '      </div>';
      html += '    </div>';
