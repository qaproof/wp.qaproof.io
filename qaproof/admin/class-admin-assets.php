    ...
    public static function enqueue_assets( $hook ) {
        ...
        wp_localize_script( 'qaproof-helpers', 'qaproof', [
            ...
            'i18n' => [
                ...
                'loadingResponsive'      => __( 'Capturing 5 viewport sizes and analyzing responsive behavior...', 'qaproof' ),
                'loadingResponsiveSub'   => __( 'This may take 2-4 minutes (5 screenshots + AI analysis)', 'qaproof' ),
                ...
                'loadingDefaultSub'      => __( 'This may take 1-5 minutes', 'qaproof' ),
                ...
                'monitorNoResults'       => __( 'No results yet. Click "Check Now" to run the first check.', 'qaproof' ),
                ...
                'apiKeyLengthError'      => __( 'Key should look like qap_live_sk_ followed by 48 hex characters (60 characters total).', 'qaproof' ),
                ...
                'pdfOf'                  => __( 'of ', 'qaproof' ),
                'pdfQaproofMark'         => __( 'QAPROOF', 'qaproof' ),
                'pdfAutomatedCheck'      => __( 'Automated check', 'qaproof' ),
